  ...
  return (
    <Dialog open={!!aboutOpen} onClose={() => setAboutOpen(false)}>
      ...
      <DialogContent>
        ...
        <p>The NSF, NIH, and DoD grant data will be updated as it becomes available. We plan to expand to other federal agencies that make their grant data openly available. New functionality depends on time availability on our side but also need from users. If you would like us to add something new to the tool, please <Link href="mailto:jevinw@uw.edu?subject=GrantExplorer">email us</Link>.</p>
