  ...
  return (
    <Dialog open={!!aboutOpen} onClose={() => setAboutOpen(false)}>
      ...
      <DialogContent>
        ...
        <p>Grant data from many federal agencies is openly available. Anyone can run this kind analysis on their own. However, it is not available in a form that is quick and easy to analyze? One would have to download large XML files, clean the data, and find the right software. We wanted to make it easy for anyone to examine this data in a web browser with the most up-to-date data. This could be useful for researchers applying for grants, philanthropists developing research portfolios, or government leaders wanting to assess technology trends. There are other similar (and great), free resources and websites that make grant data available, including USAspending.org, but none of them provide the functionality for the type of research questions and term exploration that we were looking for.</p>
        <h3>Who created the tool?</h3>
        <p>The tool started following a conversation between Chris Mentzel and Adam Jones at the Moore Foundation and Jevin West at the University of Washington. There seemed to be no tool for easily exploring what terms are being funded, how those terms are changing, and what new terms are emerging. We are still working on adding new features, but the current version allows one to explorer some aspects of these questions. This is important to philanthropists wanting to complement rather than replicate federal research funding. It also allows funders to track the growth of emergent terms in grant data. The tool itself was built by Cole Chamberlin and Jason Portenoy, both former students at the DataLab (Information School, University of Washington). Cole developed the language model and frontend and Jason aggregated and engineered the data backend.</p>
        <h3>Is it really free?</h3>
        <p>Yes, it is free. There is no cost and no freemium model. Our data and tools are openly available with this open source license [open source license]. The only thing we ask is that you cite the project if you use it in publications or elsewhere: Chamberlin, Cole and Portenoy, Jason and West, Jevin. (2022) GrantExplorer.org. DataLab, Information School, University of Washington.</p>
        <h3>Who funded the tool?</h3>
        <p>The Moore Foundation funded the development of the tool.</p>
        ...
        <p>[Jason please put dates for the NSF, NIH, and DoD.]</p>
