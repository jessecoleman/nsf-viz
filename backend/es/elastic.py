from elasticsearch_dsl import Search, MultiSearch, Document, Date, Keyword, Text, Index, connections, analyzer
...
class Grant(Document):
    title = Text()
    abstract = Text(term_vector='with_position_offsets')
    date = Date()
    division = Keyword()
...
nsf.analyzer(aggressive_analyzer)
